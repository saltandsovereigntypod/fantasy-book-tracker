...
assert.match(index,/20260801-23/);
assert.match(bridge,/ASSET_VERSION = '20260801-23'/);
assert.ok(['visual-fields.js','visual-assets.js','visual-fonts.js','canvas-editor.js','visual-builder.js'].every((file,index,array)=>index===0||bridge.indexOf(array[index-1])<bridge.indexOf(file)));
