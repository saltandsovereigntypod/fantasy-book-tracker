...
assert.match(source,/renderTemplateCanvas\(editorDraft,record,\{editor:true,size:previewSize\}\)/,'builder calls shared renderer');assert.match(source,/renderTemplateCanvas\(template,book,\{visible,presentation,size\}\)/,'library card calls shared renderer');
