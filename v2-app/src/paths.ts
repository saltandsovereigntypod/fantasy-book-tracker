...
export const PATHS: Record<PathId, PathDefinition> = {
  rider: { id:'rider', name:'Dragon Rider', short:'Riders Quadrant', glyph:'🐉', creatureKind:'dragon', ranks:['Candidate','Rider Cadet','Bonded Rider','Squad Leader','Section Leader','Wingleader'], thresholds:[0,1000,5000,15000,35000,70000], progressName:'Command', event:'Threshing', bondedRank:2, copy:copy.rider, theme:{ background:'#0c0c0d', panel:'#141416', panelAlt:'#1a1a1d', surface:'#202024', text:'#f5f2ea', muted:'#aaa59b', accent:'#8f1f2f', accentContrast:'#ffffff', accentSoft:'rgba(143,31,47,.18)', border:'#343238', paper:'#d8c4a4' } },
  scribe: { id:'scribe', name:'Scribe', short:'Scribe Quadrant', glyph:'🪶', ranks:['Scribe Candidate','Scribe Cadet','Archivist','Senior Archivist','Royal Archivist','Curator'], thresholds:[0,1000,4500,14000,32000,65000], progressName:'Scholarly Standing', event:null, bondedRank:null, copy:copy.scribe, theme:{ background:'#17140f', panel:'#211d16', panelAlt:'#2a241b', surface:'#342d22', text:'#f4ead2', muted:'#c1b392', accent:'#9b7434', accentContrast:'#17140f', accentSoft:'rgba(155,116,52,.18)', border:'#4b402f', paper:'#eadbb9' } },
  gryphon: { id:'gryphon', name:'Gryphon Flier', short:'Poromiel Drift', glyph:'🦅', creatureKind:'gryphon', ranks:['Flier Candidate','Flier Cadet','Bonded Flier','Driftleader','Wing Captain','Flight Commander'], thresholds:[0,1000,5000,15000,35000,70000], progressName:'Defiance', event:'The Leap', bondedRank:2, copy:copy.gryphon, theme:{ background:'#17100b', panel:'#21170f', panelAlt:'#2b1d13', surface:'#39271a', text:'#f0dfc2', muted:'#bca786', accent:'#a75b2b', accentContrast:'#ffffff', accentSoft:'rgba(167,91,43,.18)', border:'#4a3524', paper:'#d8c4a4' } },
  dark: { id:'dark', name:'Dark Wielder', short:'The Source Below', glyph:'🐲', creatureKind:'wyvern', ranks:['Initiate','Asim','Sage','Maven'], thresholds:[0,20000,75000,200000], progressName:'Power', event:'First Channeling', bondedRank:0, copy:copy.dark, theme:{ background:'#100814', panel:'#190d20', panelAlt:'#24102e', surface:'#32143e', text:'#f4e7f7', muted:'#c2a5c9', accent:'#a13bc2', accentContrast:'#ffffff', accentSoft:'rgba(161,59,194,.20)', border:'#472354', paper:'#d8c4a4' } },
  infantry: { id:'infantry', name:'Infantry', short:'Infantry Quadrant', glyph:'🛡️', ranks:['Infantry Recruit','Infantry Cadet','Squad Corporal','Squad Sergeant','Company Captain','Battalion Commander'], thresholds:[0,1000,4500,14000,32000,65000], progressName:'Merit', event:null, bondedRank:null, copy:copy.infantry, theme:{ background:'#0a1019', panel:'#101a27', panelAlt:'#152234', surface:'#1c2b40', text:'#e6edf7', muted:'#9cabbd', accent:'#365f94', accentContrast:'#ffffff', accentSoft:'rgba(54,95,148,.20)', border:'#283a51', paper:'#d8c4a4' } },
  healer: { id:'healer', name:'Healer', short:'Healer Quadrant', glyph:'⚕️', ranks:['Healer Candidate','Healer Cadet','Field Healer','Senior Healer','Master Healer','Chief Healer'], thresholds:[0,1000,4500,14000,32000,65000], progressName:'Mastery', event:null, bondedRank:null, copy:copy.healer, theme:{ background:'#0d171b', panel:'#142126', panelAlt:'#1a2b31', surface:'#21373f', text:'#eaf4f5', muted:'#a8c0c6', accent:'#5faac3', accentContrast:'#071216', accentSoft:'rgba(95,170,195,.18)', border:'#2b4751', paper:'#d8c4a4' } }
};
