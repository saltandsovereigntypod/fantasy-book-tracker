...
assert.match(source,/renderCard\(editorDraft,record,\{editor:editorView===\'edit\'/,'builder calls authoritative renderer');assert.match(source,/renderCard\(template,book,\{visible,presentation,size,device\}\)/,'library card calls authoritative renderer');
