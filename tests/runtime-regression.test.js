...
assert.match(bridge,/\['app\.js', 'hotfix\.js', 'runtime-patches\.js', 'investigation-features\.js', 'infinite-wall\.js', 'mind-map\.js', 'dossier-experience\.js', 'canvas-editor\.js', 'visual-builder\.js'\]/,'runtime order is deterministic and loads the Fabric canvas engine before the VisualBuilder bridge');
