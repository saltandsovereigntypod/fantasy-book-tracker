...
for(const hook of ['data-editing-mode="freeform"','data-editing-mode="expert"','data-anchor-type','data-inspect-scaling-curve','data-preview-mode'])assert.ok(source.includes(hook),hook);
