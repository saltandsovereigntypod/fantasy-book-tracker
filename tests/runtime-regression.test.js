...
assert.match(bridge,/\['app\.js', 'hotfix\.js', 'runtime-patches\.js', 'investigation-features\.js', 'infinite-wall\.js', 'mind-map\.js', 'dossier-experience\.js', 'visual-fields\.js', 'canvas-editor\.js', 'visual-builder\.js'\]/,'runtime order is deterministic and loads the field registry before the Fabric canvas engine and VisualBuilder bridge');
