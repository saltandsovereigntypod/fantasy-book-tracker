(() => {
  ...
  let saveTimer;
  let mode = 'signin';
  const ASSET_VERSION = '20260802-33';
  const APP_SCRIPTS = ['app.js', 'hotfix.js', 'runtime-patches.js', 'investigation-features.js', 'infinite-wall.js', 'mind-map.js', 'dossier-experience.js', 'canvas-editor.js', 'visual-builder.js'];
