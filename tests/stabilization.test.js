...
assert.match(index,/20260802-36/);
assert.match(bridge,/ASSET_VERSION = '20260802-36'/);
assert.match(bridge,/\['app\.js', 'hotfix\.js', 'runtime-patches\.js', 'investigation-features\.js', 'infinite-wall\.js', 'mind-map\.js', 'dossier-experience\.js', 'visual-fields\.js', 'canvas-editor\.js', 'visual-builder\.js'\]/);
