...
assert.match(index,/20260801-25/);
assert.match(bridge,/ASSET_VERSION = '20260801-25'/);
assert.ok(['visual-fields.js','visual-assets.js','visual-fonts.js','visual-builder.js'].every((file,index,array)=>index===0||bridge.indexOf(array[index-1])<bridge.indexOf(file)));
