...
assert.ok(['app.js','hotfix.js','runtime-patches.js','investigation-features.js','infinite-wall.js','mind-map.js','dossier-experience.js','visual-fields.js','visual-assets.js','visual-fonts.js','canvas-editor.js','visual-builder.js'].every((file,index,array)=>index===0||bridge.indexOf(array[index-1])<bridge.indexOf(file)),'runtime order is deterministic');
